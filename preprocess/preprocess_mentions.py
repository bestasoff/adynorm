...
def expand_abbreviations(concept: List[Any], abbreviation_dict: Dict[str, str]) -> List[Any]:
...
def process_records_without_cui(concept: List[Any], remove_without_cui: bool, cui_set: Set[str]) -> List[Any]:
    processed = []
