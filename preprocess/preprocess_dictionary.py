...
def preprocess(
    ...
    if cover_path is not None:
        add_data = []
        concept_files = glob.glob(os.path.join(cover_path, "*.concept"))
...
def main():
    ...
    parser.add_argument('--cover_data_path', type=str, default=None,
                        help='Path to other data to cover original.')
